...
<div class="container py-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
      ...
      <a
        href="<c:url value='/attend/classrooms/${classroomId}/export'/>"
    ...
    <div class="row g-4 mb-4">
      <div class="col-md-3">
        <div class="card bg-primary text-white h-100 shadow-sm border-0">
          <div class="card-body">
            <h6 class="card-title text-uppercase mb-2 opacity-75">
              Tổng buổi học
            </h6>
...
<script>
  document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(
      "${pageContext.request.contextPath}/attend/classrooms/" +
        classroomId +
        "/stats"
    )
      .then((response) => {
      ...
      .catch((err) => {
        console.error(err);
        alert("Lỗi tải dữ liệu thống kê: " + err.message);
      });
  });
