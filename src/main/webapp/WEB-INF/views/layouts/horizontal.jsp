...
<title>Layout Horizontal - Admin Dashboard</title>
...
<link rel="stylesheet" crossorigin href="<c:url value='/assets/compiled/css/iconly.css' />">
</head>
<body>
	...
	<script src="<c:url value='/assets/static/js/pages/horizontal-layout.js' />"></script>
